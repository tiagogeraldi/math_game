class User < ApplicationRecord
  ...
  has_many :sent_invites, class_name: 'Invite', foreign_key: :from_id, dependent: :nullify
  has_many :received_invites, class_name: 'Invite', foreign_key: :to_id, dependent: :nullify
